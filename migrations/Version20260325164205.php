 ...
 */
final class Version20260325164205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN candidature.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN candidature.user_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN candidature.entreprise_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE entreprise (id UUID NOT NULL, nom VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN entreprise.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE entretien (id UUID NOT NULL, candidature_id UUID NOT NULL, date_entretien DATE NOT NULL, heure_entretien TIME(0) WITHOUT TIME ZONE DEFAULT NULL, statut VARCHAR(255) NOT NULL, resultat VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2B58D6DAB6121583 ON entretien (candidature_id)');
        $this->addSql('COMMENT ON COLUMN entretien.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN entretien.candidature_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE relance (id UUID NOT NULL, candidature_id UUID NOT NULL, date_relance TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type VARCHAR(50) DEFAULT NULL, contenu TEXT DEFAULT NULL, rang SMALLINT NOT NULL, faite BOOLEAN DEFAULT false NOT NULL, date_realisation TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_50BBC126B6121583 ON relance (candidature_id)');
        $this->addSql('COMMENT ON COLUMN relance.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN relance.candidature_id IS \'(DC2Type:uuid)\'');
